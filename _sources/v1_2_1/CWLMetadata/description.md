...
- `s:keywords` — a [CWLKeywordList](bblocks://ogc.cwl.v1_2_1.CWLKeywordList) of free-text terms used
  for search and categorization, drawn from the schema.org `Thing/keywords` property that
  `CommonWorkflowLanguage.yml` mixes into every process.
